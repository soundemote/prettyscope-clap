...
## Suggested Next Commands
    ...
    powershell -ExecutionPolicy Bypass -File .\scripts\test-dot-image-clear-source.ps1
    ...
    powershell -ExecutionPolicy Bypass -File .\scripts\test-screen-burn-renderer-source.ps1
