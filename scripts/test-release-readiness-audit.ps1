...
Require-Text "dot image load source verifier" 'dot-image load source verifier checks that dot `Load`'
Require-Text "dot image load source verifier coverage" 'source-verifier coverage for load formats, clear-to-generated behavior, normalization'
Require-Text "dot image save source verifier" 'dot-image save source verifier checks that dot `Save`'
Require-Text "generated dot source verifier coverage" 'source verifier checks generated-dot PNG export wiring'
Require-Text "loaded dot source verifier coverage" 'source verifier checks loaded-image PNG export wiring'
Require-Text "dot image clear source verifier" 'dot-image clear source verifier checks that dot `Clear`'
Require-Text "dot image clear source verifier coverage" 'clear-to-generated behavior'
Require-Text "dot image state source verifier" 'dot-image state source verifier checks that loaded image labels and PNG'
Require-Text "dot image state source verifier coverage" 'PNG payloads, labels, and renderer refresh'
...
Require-Text "answer sheet helper" 'DAW answer sheet helper creates and applies a JSON answer file'
Require-Text "report field update smoke coverage" 'report field update smoke test verifies both pass-ready and fix-needed'
Require-Text "answer sheet smoke coverage" 'DAW answer sheet smoke test verifies the JSON workflow'
...
Require-Text "daw test gap helper" 'DAW test gap helper summarizes the latest report'
...
Require-Text "objective coverage script" 'objective coverage script summarizes local implementation coverage'
...
Require-Text "handoff opener" 'DAW test handoff opener opens the latest report, answer sheet'
Require-Text "handoff currency verifier" 'DAW handoff currency verifier checks that the latest report, release\s+answer sheet'
...
Require-Text "dashboard current gaps" 'current report gaps'
Require-Text "release candidate summary" 'release candidate summary script writes a Markdown snapshot'
Require-Text "release summary objective coverage" 'release candidate summary includes objective coverage'
Require-Text "summary current gaps" 'release candidate summary includes current report gaps'
